(function (module) {
  mifosX.controllers = _.extend(module, {
    CreateLoanProductController: function (
      scope,
      $rootScope,
      resourceFactory,
      location,
      ...
      resourceFactory.loanProductResource.get(
        ...
        function (data) {
          ...
          scope.liabilityAccountOptions =
            scope.product.accountingMappingOptions.liabilityAccountOptions ||
            [];
          ...
          scope.formData.repaymentFrequencyType =
            scope.product.repaymentFrequencyType.id;
          ...
          scope.formData.transactionProcessingStrategyCode =
            scope.product.transactionProcessingStrategyOptions[0].code;
          scope.formData.principalVariationsForBorrowerCycle =
            scope.product.principalVariationsForBorrowerCycle;
          scope.formData.interestRateVariationsForBorrowerCycle =
            scope.product.interestRateVariationsForBorrowerCycle;
          scope.formData.numberOfRepaymentVariationsForBorrowerCycle =
          ...
          scope.formData.isInterestRecalculationEnabled =
        ...
        scope.configureFundOptions.push({
          paymentTypeId:
            scope.product.paymentTypeOptions.length > 0
              ? scope.product.paymentTypeOptions[0].id
              : "",
          fundSourceAccountId:
            scope.assetAccountOptions.length > 0
              ? scope.assetAccountOptions[0].id
              : "",
          paymentTypeOptions:
            scope.product.paymentTypeOptions.length > 0
  ...
  mifosX.ng.application
    .controller("CreateLoanProductController", [
      "$scope",
      "$rootScope",
      "ResourceFactory",
      "$location",
      ...
      "WizardHandler",
      "$translate",
      mifosX.controllers.CreateLoanProductController,
    ])
    .run(function ($log) {
